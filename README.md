...
O modelo [ChatGPT](https://chat.openai.com/chat) é um grande modelo de linguagem treinado por [OpenAI](https://openai.com) que é capaz de gerar texto semelhante ao humano. Ao fornecer um prompt, ele pode gerar respostas que continuam a conversa ou expandem o prompt fornecido.
